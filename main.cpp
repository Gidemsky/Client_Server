...
//10X10
    ...
    cout << "-------------- input 10 ---------------" << endl << endl;
    bestTest(input10);
    aStarTest(input10);
    bfsTest(input10);
    dfsTest(input10);
    cout << "-------------- input 15 ---------------" << endl << endl;
    bestTest(input15);
    aStarTest(input15);
    bfsTest(input15);
    dfsTest(input15);
    cout << "-------------- input20 ---------------" << endl << endl;
    bestTest(input20);
    aStarTest(input20);
    bfsTest(input20);
    dfsTest(input20);
    cout << "-------------- input25 ---------------" << endl << endl;
    bestTest(input25);
    aStarTest(input25);
    bfsTest(input25);
    dfsTest(input25);
    cout << "-------------- input30 ---------------" << endl << endl;
    bestTest(input30);
    aStarTest(input30);
    bfsTest(input30);
    dfsTest(input30);
    cout << "-------------- input35 ---------------" << endl << endl;
    bestTest(input35);
    aStarTest(input35);
    bfsTest(input35);
    dfsTest(input35);
    cout << "-------------- input40 ---------------" << endl << endl;
    bestTest(input40);
    aStarTest(input40);
    bfsTest(input40);
    dfsTest(input40);
    cout << "-------------- input42 ---------------" << endl << endl;
    bestTest(input42);
    aStarTest(input42);
    bfsTest(input42);
    dfsTest(input42);
    cout << "-------------- input45 ---------------" << endl << endl;
    bestTest(input45);
    aStarTest(input45);
    bfsTest(input45);
    dfsTest(input45);
    cout << "-------------- input50 ---------------" << endl << endl;
    bestTest(input50);
    aStarTest(input50);
    bfsTest(input50);
    dfsTest(input50);
